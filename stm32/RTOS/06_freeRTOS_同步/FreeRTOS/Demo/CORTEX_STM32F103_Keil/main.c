...
int main(void)
{
	...
	prvSetupHardware();
	printf("begin!\n");
	xTaskCreate(Task1Function, "Task1", 1024, "hello task1", 0, &xHandleTask1); // 动态任务
	xTaskCreate(Task2Function, "Task2", 1024, "my name is liuxunzi", 0, &xHandleTask2);
	xTaskCreate(Task3Function, "Task3", 1024, NULL, 1, &xHandleTask3);
