...
#define LEDn 4                            /*LED数量*/
#define GPIO_LED GPIOA                    /*LED灯使用的GPIO组*/
...
/*KEY按键相关定义*/
#define RCC_GPIO_KEY RCC_APB2Periph_GPIOB /*KEY使用的GPIO时钟*/
#define KEYn 2                            /*KEY数量*/
#define GPIO_KEY GPIOB                    /*KEY灯使用的GPIO组*/

#define KEY1_PIN GPIO_Pin_0 /*KEY1使用的GPIO管脚*/
#define KEY2_PIN GPIO_Pin_1 /*KEY2使用的GPI1管脚*/
